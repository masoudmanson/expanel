var Login = function () {
    var r = function () {
        $(".login-form").validate({
            ...
            messages: {email: {required: "لطفا یک نام کاربری وارد کنید!"}, password: {required: "لطفا رمز عبور را وارد کنید!"}},
    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch(["../assets/pages/img/login/bg1.jpg", "../assets/pages/img/login/bg2.jpg", "../assets/pages/img/login/bg3.jpg", "../assets/pages/img/login/bg4.jpg", "../assets/pages/img/login/bg5.jpg", "../assets/pages/img/login/bg6.jpg"], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
